...
export type TripStop={id:string;key:string;backendId?:number;name:string;city:string;kind:'poi'|'experience';address?:string|null;notes?:string|null;coordinates:Coordinates|null;status:StopStatus;sourceIndex:number;startTime?:string|null;endTime?:string|null;sortOrder:number;original?:boolean};
